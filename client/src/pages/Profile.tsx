...
export default function Profile() {
  ...
  // If user is not found or error, but not for own profile when user is authenticated
  if ((!isUserLoading && !userData) || userError) {
    // Special case: if viewing own profile and user is authenticated but data not loaded yet
    if (isOwnProfile && isAuthenticated && !userError) {
      return (
  ...
  // If viewing own profile but user data is not yet loaded
  if (isOwnProfile && !userData && !isUserLoading && currentUser?.id) {
